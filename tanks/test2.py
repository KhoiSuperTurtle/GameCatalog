...
font4 = pygame.font.Font(None, 96)
zet = 0
initbase = True
basehp = 2
plives = 3
...
menupos = pygame.Rect(45, 340,247,45)
menu2 = font3.render(u'Выход', 1, (255, 255, 10))
menupos2 = pygame.Rect(45, 400,154,45)
menu3 = font4.render(u'Battle tanks', 1, (255, 0, 0))
menupos3 = pygame.Rect(125, 40,247,45)
def mmenu(go):
        global menu, menu2,menupos,menupos2,menu3,menupos3, done
        while not go:
