...
soundOnJump = pygame.mixer.Sound('dino/resources/jump.wav')
soundOnDie = pygame.mixer.Sound('dino/resources/die.wav')
soundOnCheckpoint = pygame.mixer.Sound('dino/resources/checkPoint.wav')

def load_image(name,sx=-1,sy=-1,colorkey=None):

    fullname = os.path.join('dino/resources', name)
...
def load_sprite_sheet(
    ...
    fullname = os.path.join('dino/resources', s_name)
...
def introduction_screen():
    ...
    logo,l_rect = load_image('logo-1.png',300,140,-1)
